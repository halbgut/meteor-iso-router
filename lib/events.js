...
createEvent = function createEvent (eventName, eventData) {
  ...
  if(Meteor.isClient) return new CustomEvent(eventName, { detail: eventData })
}
...
if(Meteor.isServer) {
  ...
  // TODO: This should be the function to add to the end of the array of eventListeners
  eventTarget.addEventListener = eventTarget.addListener
  console.log(eventTarget.__proto__)
} else {
