...
* [Route](#Route) : <code>object</code>
  ...
  * [.enter(An)](#Route.enter)
  * [.exit(The)](#Route.exit)
  * [.match(The)](#Route.match) ⇒ <code>false</code> &#124; <code>array</code>
...
| Param | Type | Description |
| --- | --- | --- |
| An | <code>[enterHook](#Route.enterHook)</code> | enter hook to be added to the route |
...
| Param | Type | Description |
| --- | --- | --- |
| The | <code>[exitHook](#Route.exitHook)</code> | exit hook to add |

<a name="Route.match"></a>
### Route.match(The) ⇒ <code>false</code> &#124; <code>array</code>
...
| Param | Type | Description |
| --- | --- | --- |
| The | <code>string</code> | url to execute the regex on |
